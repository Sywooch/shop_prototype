...
$params = [
    ...
    'popularLimit'=>5, # Кол-во популярных товаров для админ раздела
    ...
    'adminOrdersFilters'=>'adminOrdersFilters', # Ключ, по которому в $_REQUEST доступны фильтры заказов админ раздела
