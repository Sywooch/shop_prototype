 ...
 */
class AdminCreateBrandWidget extends AbstractBaseWidget
{
    /**
    ...
    /**
     * Присваивает значение AdminCreateBrandWidget::form
    ...
    /**
     * Присваивает значение AdminCreateBrandWidget::header
     * @param string $header
     */
    ...
    /**
     * Присваивает значение AdminCreateBrandWidget::template
