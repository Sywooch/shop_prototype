 ...
 */
class UnsubscribeSuccessWidget extends AbstractBaseWidget
{
    /**
    ...
    public function run()
    {
        try {
            ...
            $renderArray['text'] = \Yii::t('base', 'You successfully unsubscribed from mailings:');
    ...
    /**
     * Присваивает array MailingsModel свойству UnsubscribeSuccessWidget::mailings
    ...
    /**
     * Присваивает имя шаблона свойству UnsubscribeSuccessWidget::template
