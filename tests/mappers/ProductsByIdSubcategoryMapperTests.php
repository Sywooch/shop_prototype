...
use app\tests\{DbManager, 
    MockModel};
use app\mappers\ProductsByIdSubcategoryMapper;
use app\models\{ProductsModel,
    SubcategoryModel};
use app\helpers\MappersHelper;

/**
 * Тестирует класс app\mappers\ProductsByIdSubcategoryMapper
 */
class ProductsByIdSubcategoryMapperTests extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Тестирует метод ProductsByIdSubcategoryMapper::getOneFromGroup
     */
