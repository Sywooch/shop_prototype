...
use app\tests\{DbManager, 
    MockModel};
use app\mappers\GetCategoriesByIdMapper;
use app\models\CategoriesModel;
use app\helpers\MappersHelper;

/**
 * Тестирует класс app\mappers\GetCategoriesByIdMapper
 */
class GetCategoriesByIdMapperTests extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Тестирует метод GetCategoriesByIdMapper::getOneFromGroup
     */
    public function testGetOneFromGroup()
    {
        $categoriesByIdMapper = new GetCategoriesByIdMapper([
