...
use app\mappers\GetBrandsMapper;
use app\models\BrandsModel;
use app\helpers\MappersHelper;

/**
 * Тестирует класс app\mappers\GetBrandsMapper
 */
class GetBrandsMapperTests extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Тестирует метод GetBrandsMapper::getGroup
     */
    public function testGetGroup()
    {
        $_GET = [];
        
        $brandsMapper = new GetBrandsMapper([
            'tableName'=>'brands',
            'fields'=>['id', 'brand'],
        ]);
    ...
    /**
     * Тестирует метод GetBrandsMapper::getGroup с учетом категории
     */
    ...
    /**
     * Тестирует метод GetBrandsMapper::getGroup с учетом категории и подкатегории
     */
