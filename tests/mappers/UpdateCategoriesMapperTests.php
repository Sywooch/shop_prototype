...
use app\tests\{DbManager, 
    MockModel};
use app\mappers\UpdateCategoriesMapper;
use app\helpers\MappersHelper;

/**
 * Тестирует класс app\mappers\UpdateCategoriesMapper
 */
class UpdateCategoriesMapperTests extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Тестирует метод UpdateCategoriesMapper::setGroup
     */
    public function testSetGroup()
    {
        $categoriesUpdateMapper = new UpdateCategoriesMapper([
