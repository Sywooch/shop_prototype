...
use app\tests\{DbManager, 
    MockModel};
use app\mappers\CategoriesDeleteMapper;
use app\helpers\MappersHelper;
use app\models\CategoriesModel;

/**
 * Тестирует класс app\mappers\CategoriesDeleteMapper
 */
class CategoriesDeleteMapperTests extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Тестирует метод CategoriesDeleteMapper::setGroup
     */
