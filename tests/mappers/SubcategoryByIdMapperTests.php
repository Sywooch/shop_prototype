...
/**
 * Тестирует класс app\mappers\SubcategoryByIdMapper
 */
class SubcategoryByIdMapperTests extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Тестирует метод SubcategoryByIdMapper::getOneFromGroup
     */
