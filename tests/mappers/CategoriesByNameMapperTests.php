...
use app\tests\{DbManager, 
    MockModel};
use app\mappers\CategoriesByNameMapper;
use app\models\CategoriesModel;
use app\helpers\MappersHelper;

/**
 * Тестирует класс app\mappers\CategoriesByNameMapper
 */
class CategoriesByNameMapperTests extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Тестирует метод CategoriesByNameMapper::getOneFromGroup
     */
