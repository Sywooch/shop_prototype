...
use app\mappers\BrandsAdminMapper;
use app\models\BrandsModel;
use app\helpers\MappersHelper;

/**
 * Тестирует класс app\mappers\BrandsAdminMapper
 */
class BrandsAdminMapperTests extends \PHPUnit_Framework_TestCase
{
    private static $_dbClass;
    private static $_id = 1;
    private static $_name = 'Some Name';
    private static $_brand = 'gray';
    ...
    /**
     * Тестирует метод BrandsAdminMapper::getGroup
     */
    public function testGetGroup()
    {
        $brandsMapper = new BrandsAdminMapper([
            'tableName'=>'brands',
            'fields'=>['id', 'brand'],
        ]);
    ...
    /**
     * Тестирует метод BrandsAdminMapper::getGroup с учетом категории
     */
    ...
    /**
     * Тестирует метод BrandsAdminMapper::getGroup с учетом категории и подкатегории
     */
