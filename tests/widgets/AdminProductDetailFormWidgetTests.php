...
class AdminProductDetailFormWidgetTests extends TestCase
{
    ...
    public function testRun()
    {
        ...
        $this->assertRegExp('#<form id="admin-products-detail-send-form-[0-9]{1}" action=".+" method="POST">#', $result);
        ...
        $this->assertRegExp('#<input type="text" id=".+" class="form-control" name=".+\[short_description\]" value=".+">#', $result);
        $this->assertRegExp('#<input type="text" id=".+" class="form-control" name=".+\[description\]" value="Description 1">#', $result);
        $this->assertRegExp('#<input type="text" id=".+" class="form-control" name=".+\[price\]" value=".+">#', $result);
        $this->assertRegExp('#<img src=".+" height="50" alt="">#', $result);
        $this->assertRegExp('#<input type="text" id=".+" class="form-control" name=".+\[images\]">#', $result);
        ...
        $this->assertRegExp('#<label><input type="radio" id=".+" name=".+\[active\]" value="[0-9]{1}" checked> .+</label>#', $result);
