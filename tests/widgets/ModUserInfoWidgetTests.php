...
use app\widgets\ModUserInfoWidget;
use yii\web\User;
use app\forms\AbstractBaseForm;

class ModUserInfoWidgetTests extends TestCase
{
    private $widget;
    
    public function setUp()
    {
        $this->widget = new ModUserInfoWidget();
    }
    ...
    {
        $reflection = new \ReflectionClass(ModUserInfoWidget::class);
    ...
    /**
     * Тестирует метод ModUserInfoWidget::setUser
     */
    ...
    /**
     * Тестирует метод ModUserInfoWidget::setForm
     */
    ...
    /**
     * Тестирует метод ModUserInfoWidget::setTemplate
     */
    ...
    public function testRunGuest()
    {
        ...
        $reflection = new \ReflectionProperty($this->widget, 'template');
        $reflection->setAccessible(true);
        $reflection->setValue($this->widget, 'user-info-mod.twig');
        
        $result = $this->widget->run();
        
        $this->assertRegExp('#<div id="user-info">#', $result);
        $this->assertRegExp('#<a href=".+">Войти</a><span class="separate">/</span><a href=".+">Регистрация</a>#', $result);
    }
    ...
    public function testRunUser()
    {
        ...
        $this->assertRegExp('#<div id="user-info">#', $result);
        $this->assertRegExp('#<a href=".+">some@some.com</a><span class="separate">/</span><span class="logout">Выйти</span>#', $result);
        $this->assertRegExp('#<form id="user-logout-form" action=".+" method="POST">#', $result);
