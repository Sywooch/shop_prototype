...
CREATE TABLE `products` (
  ...
  CONSTRAINT `products_ibfk_1` FOREIGN KEY (`id_category`) REFERENCES `categories` (`id`) ON UPDATE CASCADE,
...
CREATE TABLE `products_colors` (
  ...
  UNIQUE KEY `product_color` (`id_product`,`id_color`),
  KEY `id_color` (`id_color`),
  CONSTRAINT `products_colors_ibfk_1` FOREIGN KEY (`id_product`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `products_colors_ibfk_2` FOREIGN KEY (`id_color`) REFERENCES `colors` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `products_sizes` (
  `id_product` smallint(5) unsigned NOT NULL,
  `id_size` tinyint(3) unsigned NOT NULL,
  UNIQUE KEY `product_size` (`id_product`,`id_size`),
  KEY `id_size` (`id_size`),
  CONSTRAINT `products_sizes_ibfk_1` FOREIGN KEY (`id_product`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `products_sizes_ibfk_2` FOREIGN KEY (`id_size`) REFERENCES `sizes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `subcategory` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_category` (`id_category`),
  CONSTRAINT `subcategory_ibfk_1` FOREIGN KEY (`id_category`) REFERENCES `categories` (`id`) ON UPDATE CASCADE
...
-- Dump completed on 2016-05-23 21:45:09
