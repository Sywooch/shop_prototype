        ...
        try {
            ...
            function success(data, status, jqXHR) {
                ...
                $(container).on('click', 'td', this, function(event) {
                    ...
                    if (event.data.target.attr('class') == 'calendar-href-to') {
                    ...
                    if (event.data.target.attr('class') == 'calendar-href-from') {
                    ...
                    event.data.target.html(eventTarget.attr('data-format'));
                    event.data.target.attr('data-timestamp', eventTarget.attr('data-timestamp'));
